...
void main() {
  ...
  group('Home Screen Integration Tests', () {
    testWidgets('Home Screen - Initial Load and UI Elements', (WidgetTester tester) async {
      // Start the app
      app.main();
      ...
      expect(emptyState.evaluate().isNotEmpty || projectList.evaluate().isNotEmpty, isTrue);
    });

    testWidgets('Home Screen - Navigation to Add Project', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
    ...
    testWidgets('Home Screen - Navigation to Editor Management', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
    ...
    testWidgets('Home Screen - Search Functionality', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
    ...
    testWidgets('Home Screen - Group Filter Functionality', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
