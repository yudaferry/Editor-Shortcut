...
void main() {
  ...
  group('Dummy Data Tests - Grande Server Projects', () {
    ...
    final projectData = [
      {
        ...
        'description': 'Administrative server for managing clients and configurations',
        'group': 'Backend Services'
      },
      {
        'name': 'Base Server',
        'path': '/home/yuda/Grande-server/Base_Server',
        'description': 'Core base server with shared functionality and middleware',
        'group': 'Backend Services'
      },
      {
        'name': 'BO Server',
        'path': '/home/yuda/Grande-server/BO_Server',
        'description': 'Back office server for business operations and management',
        'group': 'Backend Services'
      },
      {
        'name': 'Login Server',
      ...
      },
      {
        ...
        'description': 'Reporting and analytics server for business intelligence',
        'group': 'Analytics'
      },
      {
    ...
    testWidgets('Add 9 Grande Server projects with dummy data', (WidgetTester tester) async {
      // Start the app
      app.main();
    ...
    testWidgets('Clean up - Remove all test projects', (WidgetTester tester) async {
      // Start the app
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
      ...
      while (attempts < maxAttempts) {
        ...
        if (projectDeleted) {
          ...
          print('⚠️  Could not find delete action for project (attempt $attempts)');
          ...
          if (attempts >= 5) {
            ...
            print('   This might be because delete functionality is not implemented');
    ...
    testWidgets('Verify clean state after cleanup', (WidgetTester tester) async {
      ...
      if (projectCards.evaluate().isEmpty || emptyMessage.evaluate().isNotEmpty) {
        print('✅ App is in clean empty state');
      } else {
        print('⚠️  Projects may still exist: ${projectCards.evaluate().length} cards found');
      }
